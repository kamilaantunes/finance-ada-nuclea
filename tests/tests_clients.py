...
class TestStringMethods(unittest.TestCase):
    ...
    def test_cliente(self):
        ...
        cpf = gera_cpf()
        inputs = ["1", nome, cpf, "12.345.678-x", "12/02/2001", "05003060", "42", "n"]
        ...
        cliente_esperado = {
            ...
            "endereco": {'CEP': '05003-060', 'Logradouro': 'Rua Higino Pellegrini', 'Complemento': '', 'Bairro': 'Água Branca', 'Cidade': 'São Paulo', 'Estado': 'SP'},
            "numero_casa": "42",
        }
